...
== Installation ==
After downloading the plugin [HERE](https://wordpress.org/plugins/formula04-site-lock/); install it by uploading it into your plugin directory or using the built in [WordPress plugin installer](https://codex.wordpress.org/Managing_Plugins#Installing_Plugins).
...
***Note:** *Whatever page you set this to, you will probably want to include the Formula04 SiteLock password form on it, so your users can log in.([See Usage](http://www.formula04.com/sitelock/usage/)).*
...
== Changelog ==
= 0.1 = Very basic version just meant as a proof of concept
= 1.0 = Moved plugin into a class, stripped tons of uneeded code.
